<?php 
        ...
        if(ENVIRONMENT == 1){
           ...
           //Create an instance; passing `true` enables exceptions
            ...
            try {
                ...
                $mail->SMTPAuth   = true; 
                $mail->Username   = 'johnnypablovelasquez@gmail.com';          //SMTP username
                $mail->Password   = 'Camila2627';                                   //Enable SMTP authentication
             ...
             //   $mail->Password   = '@dmin08a';                               //SMTP password
                ...
                //Recipients
                $mail->setFrom('johnnypablovelasquez@gmail.com', 'Servidor Local');
    ...
    function sendMailLocal($data,$template){
        ...
        try {
            ...
            $mail->Host       = 'smtp.gmail.com';                     //Set the SMTP server to send through
            $mail->SMTPAuth   = true;   
            $mail->Username   = 'johnnypablovelasquez@gmail.com';                                 //Enable SMTP authentication
          //  $mail->Username   = 'toolsfordeveloper@gmail.com';                     //SMTP username
            $mail->Password   = 'Camila2627';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
